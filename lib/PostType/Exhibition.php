...
namespace TMS\Theme\Milavida\PostType;
...
class Exhibition implements PostType {
    ...
    public function __construct() {
        $this->description = _x( 'Exhibition', 'theme CPT', 'tms-theme-milavida' );
    }
    ...
    private function register() {
        $labels = [
            'name'                  => _x( 'Exhibition', 'theme CPT', 'tms-theme-milavida' ),
    ...
    private function get_breadcrumbs_base( $is_cpt_archive = false ) : array {
        return [
            'home' => [
                'title'     => _x( 'Home', 'Breadcrumbs', 'tms-theme-milavida' ),
                'permalink' => trailingslashit( get_home_url() ),
                'icon'      => '',
            ],
            [
                'title'     => _x( 'Exhibition', 'Breadcrumb text', 'tms-theme-milavida' ),
